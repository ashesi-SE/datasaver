...
<head>
    ...
    <title>Data Saver : Add File</title>
    <!--icon-->
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-left">
                    <FORM METHOD="LINK" ACTION="home.php">
                        <INPUT class="btn btn-success navbar-btn" TYPE="submit" VALUE="Back To SEARCH">
                    </FORM>
                </ul>
            ...
            <div class="signup">
                ...
                <form method = "post" action= "home.php">
                        ...
                        <div class="input-group col-xs-12 padding-10">
                            <input id="btn-input" name = "file_name"type="text" class="form-control input-md margin-10" placeholder="File Name">
                        ...
                        <input class="margin-10 padding-10 col-xs-12 btn btn-primary" type="submit" name="submit" id="submit">
                </form>
        </div>
    </div>
