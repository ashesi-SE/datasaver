    		            ...
    		            <div class="searcheditem">
                            ...
                            <?php 
                               while ($row = mysql_fetch_assoc($result)) {
                                    ...
                                    echo "<ul class="list-unstyled list-inline dateComments">"
                                    echo    "<li><span class="glyphicon glyphicon-earphone"></span>&#32; Contact Number</li>"
                                    echo    "<li><a href="mailto:#"><span class="glyphicon glyphicon-envelope"></span>&#32; Email</a></li>
                                    echo "</ul>"
                                } 
